...
wo.save()
wui=WorkoutUIs(WONAME='boulder_session', WOTIME=timerange, WOREPS= reprange, WOCYCLES= cyclerange, WOMAXAVG= boulderrange, CLEANS=reprange, OTHER1=[], OTHER2=[], OTHER3=[], OTHER4=[], COMMENTS= ['textbox'])
wui.save()
...
wo.save()
wui=WorkoutUIs(WONAME='boulder_pyramid', WOTIME=timerange, WOREPS= reprange, WOCYCLES= cyclerange, WOMAXAVG= boulderrange, CLEANS=reprange, OTHER1=[], OTHER2=[], OTHER3=[], OTHER4=[], COMMENTS= ['textbox'])
wui.save()
#sport
...
wo.save()
wui=WorkoutUIs(WONAME='route_session', WOTIME=timerange, WOREPS= reprange, WOCYCLES= cyclerange, WOMAXAVG= routerange, CLEANS=reprange, OTHER1=[], OTHER2=[], OTHER3=[], OTHER4=[], COMMENTS= ['textbox'])
wui.save()
